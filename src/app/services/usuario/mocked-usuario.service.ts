...
export class MockedUsuarioService extends AbstractUsuarioService {
  ...
  override getUrlFotoById(id: number): Observable<OperationResult> {
    try {
      ...
      return of({ success: false, status: 500, message: 'Erro ao buscar URL da foto.' });
    }
  }
